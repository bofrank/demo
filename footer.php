...
<div data-role="footer" data-id="data-footer" data-position="fixed">
	<div data-role="navbar">
		<ul>
			<li><a href="#page_01" id="link_01" data-transition="slide"><i class="fa fa-map-marker" style="font-size:20px;color:#999;"></i><br>Map</a></li>
			
			<li><a href="#page_01" data-icon="star" id="link_01" data-transition="slide">Favorites</a></li>
